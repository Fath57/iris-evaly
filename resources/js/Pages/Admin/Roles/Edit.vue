    ...
    <AppLayout>
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-gray-600">Modifiez les informations et permissions du rôle</p>
            </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
