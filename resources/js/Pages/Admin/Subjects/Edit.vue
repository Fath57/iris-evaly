<template>
    <AppLayout>
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <!-- Header -->
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Modifier la matière</h1>
                <p class="mt-1 text-sm text-gray-600">Modifiez les informations de la matière</p>
            </div>
...
const form = useForm({
    ...
    color: props.subject.color || '#FF5E0E',
